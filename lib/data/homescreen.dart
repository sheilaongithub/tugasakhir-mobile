...
class home extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Daftar Kopi Terkini'),
      ),
                      ...
                      children: [
                        Text(dataResep[index].name,
                            style: TextStyle(
                                ...
                                fontSize: 25,
                                color: Color.fromARGB(255, 132, 93, 16))),
                        Text('selengkapnya'),
                        ClipOval(
                          child: Material(
                            color: Color.fromARGB(255, 243, 159, 33), // button color
                            child: InkWell(
                              splashColor: Color.fromARGB(255, 255, 18, 1), // inkwell color
                              child: SizedBox(
                                  width: 30,
                                  height: 30,
